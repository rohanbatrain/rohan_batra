...
import 'projects/linux_configuration_repository.dart';
import 'projects/linux_scripts_repository.dart';
import 'projects/suckless/st_page.dart';
import 'projects/suckless/dmenu_page.dart';
import 'projects/suckless/dwm_page.dart';
...
class _LinuxAdministrationScreenState extends State<LinuxAdministrationScreen> {
  final List<Map<String, dynamic>> categories = [
    {
      'title': 'Garuda Linux Installation',
      'projects': [
        {
                                ...
                                builder: (context) {
                                  switch (project['title']) {
                                    ...
                                    case 'Linux Configuration Repository':
                                      return LinuxConfigurationRepository();
                                    case 'Linux Scripts Repository':
                                      return LinuxScriptsRepository();
