    ...
    <div className='p-6 space-y-6'>
      ...
      <Card className='p-4'>
        <div className='flex gap-3 items-center'>
          <Input placeholder='Search name, tags' value={search} onChange={e => setSearch(e.target.value)} className='max-w-sm' />
              ...
              data.characters.map((c: Character) => (
                <TableRow key={c.id}>
                  ...
                  <TableCell className='space-x-2'>
                    ...
                    <Button size='sm' variant='destructive' onClick={() => moveToTrash(c.id)}>Move to Trash</Button>
                  </TableCell>
                </TableRow>
              ))
            )}
