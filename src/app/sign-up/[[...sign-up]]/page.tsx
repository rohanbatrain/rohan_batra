...
export const metadata: Metadata = {
  title: 'Sign Up | Rohan Batra',
  description: 'Create your account to access exclusive content and features.',
};
        ...
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center'>
            <p className='text-gray-600 dark:text-gray-400 font-medium'>
              ...
              <a
                href={`/sign-in${params.redirect_url ? `?redirect_url=${encodeURIComponent(params.redirect_url)}` : ''}`}
