  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className='w-full sm:max-w-5xl lg:max-w-6xl'>
          <DialogHeader>
              ...
              >
                ...
                <TabsContent value='course' className='space-y-6'>
                  <section className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                        ...
                        <div>
                          <Label htmlFor='course-estimated'>
                            Estimated minutes
                          </Label>
                          <Input
                            id='course-estimated'
                      ...
                      <div>
                        <Label htmlFor='course-hero-image'>
                          Hero image URL or shortcode
                        </Label>
                        <Input
                      ...
                      <div>
                        <Label htmlFor='course-hero-lottie'>
                          Hero lottie asset ID
                        </Label>
                        <Input
                  ...
                  <section className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                    <div className='space-y-3'>
                      <div>
                        <Label htmlFor='course-prereq-ids'>
                      ...
                      <div>
                        <Label htmlFor='course-prereq-blogs'>
                    ...
                    <div className='space-y-3'>
                      <div>
                        <Label htmlFor='course-recommended-blogs'>
                      ...
                      <div>
                        <Label htmlFor='course-recommended-books'>
                      ...
                      <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                        <div>
                          <Label htmlFor='course-release-at'>
                            Release schedule
                          </Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor='course-release-timezone'>
                            Timezone
                          </Label>
                          <Input
                  ...
                  <section className='space-y-3'>
                    ...
                    <div className='grid grid-cols-1 gap-3 md:grid-cols-3'>
                      ...
                      <div className='md:col-span-3'>
                        <Label htmlFor='seo-image'>
                          SEO image URL or shortcode
                        </Label>
                        <Input
                          id='seo-image'
          ...
          <DialogBody>
            <div className='space-y-3'>
              ...
              {lessonForm.contentType === 'standalone' ? (
                <div className='space-y-3'>
                  <div>
                    <Label htmlFor='lesson-standalone-format'>
                      Content format
                    </Label>
                    <Select
