...
describe('GET /api/portfolio/projects', () => {
  ...
  it('should support filtering by category', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?category=web-development')
    const data = await response.json()
  ...
  it('should support filtering by technology', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?tech=react,nextjs')
    const data = await response.json()
  ...
  it('should support filtering by status', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?status=completed')
    const data = await response.json()
  ...
  it('should support sorting by date', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?sort=recent')
    const data = await response.json()
  ...
  it('should return featured projects only', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?featured=true')
    const data = await response.json()
  ...
  it('should support pagination parameters', async () => {
    const response = await fetch('http://localhost:3000/api/portfolio/projects?page=2&limit=3')
    const data = await response.json()
