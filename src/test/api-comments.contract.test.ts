...
describe('GET /api/comments', () => {
  ...
  it('should support filtering by approval status', async () => {
    const response = await fetch('http://localhost:3000/api/comments?approved=true')
    const data = await response.json()
  ...
  it('should support pagination parameters', async () => {
    const response = await fetch('http://localhost:3000/api/comments?page=2&limit=10')
    const data = await response.json()
  ...
  it('should support sorting by date', async () => {
    const response = await fetch('http://localhost:3000/api/comments?sort=newest')
    const data = await response.json()
  ...
  it('should return only top-level comments when requested', async () => {
    const response = await fetch('http://localhost:3000/api/comments?topLevel=true')
    const data = await response.json()
  ...
  it('should include reply count for each comment', async () => {
    const response = await fetch('http://localhost:3000/api/comments?includeReplies=true')
    const data = await response.json()
  ...
  it('should support search functionality', async () => {
    const response = await fetch('http://localhost:3000/api/comments?search=helpful')
    const data = await response.json()
